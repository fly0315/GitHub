...
const Fr_transmit_buffer_config_type Fr_tx_buffer_Frame_GG_1_1ms_cfg =
{
	2,                           // Transmit frame ID
	0x40E,         //2012                // Header CRC
	10,                          // Payload length
...
const Fr_transmit_buffer_config_type Fr_tx_buffer_Frame_GG_2_1ms_cfg =
{
	12,                           // Transmit frame ID
	0x33E,      //2012                   // Header CRC
	10,                          // Payload length
	FR_DOUBLE_TRANSMIT_BUFFER,   // Transmit MB buffering
	FR_STATE_TRANSMISSION_MODE,  // Transmission mode
	FR_IMMEDIATE_COMMIT_MODE,    // Transmission commit mode
...
{ // Buffer type         Configuration structure ptr         MB index    xx = configuration index used by Fr_buffer_cfg_set_xx
	{ FR_TRANSMIT_BUFFER, &Fr_tx_buffer_Frame_GG_1_1ms_cfg,     0 },         // 00
{ FR_TRANSMIT_BUFFER, &Fr_tx_buffer_Frame_GG_2_1ms_cfg,     2 },         // 01
{ FR_RECEIVE_SHADOW,  &Fr_rx_shadow_cfg,                    4 },         // 02    
};
...
const Fr_low_level_config_type Fr_low_level_cfg_set_00 =
{
	...
	6,         /*  gdMinislot-----GD_MINISLOT */
	2,          /*  gdMinislotActionPointOffset-----GD_MINI_SLOT_ACTION_POINT_OFFSET */
	...
	1000,       /*  gdCycle-----G_MACRO_PER_CYCLE */
	...
	28,          /*  gNumberOfMinislots-----G_NUMBER_OF_MINISLOTS */
	16,          /*  gNumberOfStaticSlots-----G_NUMBER_OF_STATIC_SLOTS */
	983,        /*  gOffsetCorrectionStart-----G_OFFSET_CORRECTION_START */
	...
	40000,     /*  pMicroPerCycle-----P_MICRO_PER_CYCLE */
	337,         /*  pOffsetCorrectionOut-----P_OFFSET_CORRECTION_OUT */
	121,         /*  pRateCorrectionOut-----P_RATE_CORRECTION_OUT */
	FALSE,      /*  pSingleSlotEnabled-----P_SINGLE_SLOT_ENABLED */
	FR_CHANNEL_A,   /*  pWakeupChannel-----P_WAKEUP_CHANNEL $$$$$$$$$$$$$$$$$$$$$$$$$*/
	33,         /*  pWakeupPattern-----P_WAKEUP_PATTERN */
