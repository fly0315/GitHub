...
unsigned int UnlockFifoBuffer::Put_32(const unsigned long *pBuffer, unsigned int nLen)
{
	return Put((unsigned int*)pBuffer, nLen * 2);
}

unsigned int UnlockFifoBuffer::Get_32(unsigned long *pBuffer, unsigned int nLen)
{
	return Get((unsigned int*)pBuffer, nLen * 2);
}

unsigned int UnlockFifoBuffer::Copy_32(unsigned long *pBuffer, unsigned int nLen)
{
	return Copy((unsigned int*)pBuffer, nLen * 2);
}

unsigned int UnlockFifoBuffer::Delete_32(unsigned int nLen)
{
	return Delete(nLen * 2);
}